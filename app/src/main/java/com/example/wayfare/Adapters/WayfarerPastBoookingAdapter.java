...
public class WayfarerPastBoookingAdapter extends RecyclerView.Adapter<WayfarerPastBoookingAdapter.ViewHolder> {
    ...
    public WayfarerPastBoookingAdapter(Context context, List<BookingItemModel> pastBookingItemModels, RecyclerViewInterface recyclerViewInterface) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        holder.pastBookingWayfarer.setText("Booked by " + pastBookingItemModels.get(position).wayfarerUsername);
