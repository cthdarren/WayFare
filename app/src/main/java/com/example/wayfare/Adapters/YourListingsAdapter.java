...
public class YourListingsAdapter extends RecyclerView.Adapter<YourListingsAdapter.MyViewHolder> {

    Context context;
    ArrayList<TourListModel> tourListModels;
    private final tourListing_RecyclerViewInterface tourListing_recyclerViewInterface;
    public YourListingsAdapter(Context context, ArrayList<TourListModel> tourListingModels, tourListing_RecyclerViewInterface tourListing_recyclerViewInterface){
    ...
    @NonNull
    @Override
    public YourListingsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        // inflating layout and giving look to each view
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.list_item_your_listings, parent, false);
        return new MyViewHolder(view, tourListing_recyclerViewInterface);
    }

    @Override
    public void onBindViewHolder(@NonNull YourListingsAdapter.MyViewHolder holder, int position) {
